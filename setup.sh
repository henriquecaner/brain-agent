...
echo -e ""
echo -e "  ${YELLOW}1.${NC} Inicie a IA no seu repositório com um dos prompts mágicos abaixo:"
echo -e ""
echo -e "     ${BOLD}Se o projeto for NOVO (zerado):${NC}"
echo -e "     > \"start novo brain - Projeto zerado\""
echo -e ""
echo -e "     ${BOLD}Se o projeto JÁ EXISTIR:${NC}"
echo -e "     > \"start novo brain - Projeto existente\""
echo -e ""
