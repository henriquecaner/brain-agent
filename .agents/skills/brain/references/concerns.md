...
STATE.md is generated as part of the brownfield mapping flow (alongside STACK.md, ARCHITECTURE.md, etc.). It can also be created or updated independently when:
...
## Template: `/.specs/project/STATE.md`
...
## How STATE.md Gets Used

- **Feature planning:** Check STATE.md before designing features that touch flagged areas
- **Risk estimation:** Use fragile areas and scaling limits to estimate change risk
- **Onboarding new sessions:** Load STATE.md to give context about what to watch out for
